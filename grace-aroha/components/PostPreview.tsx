        ...
        <Card.Body>
          <div className={styles.link}>
            <div className={styles.img}>
              <Image src={post?.attributes?.image?.data?.attributes?.url ? post.attributes.image.data.attributes.url : '/images/beach-walking.jpg'} height={30} width={50} layout="responsive" />
            </div>
